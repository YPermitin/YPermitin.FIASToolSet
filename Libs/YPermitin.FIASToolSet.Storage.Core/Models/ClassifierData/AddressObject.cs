...
public class AddressObject
{
    ...
    /// <summary>
    /// Предыдущая историческая запись
    /// </summary>
    [ForeignKey("PreviousAddressObjectId")]
    public AddressObject PreviousAddressObject { get; set; }
    /// <summary>
    ...
    /// <summary>
    /// Следующая историческая запись
    /// </summary>
    [ForeignKey("NextAddressObjectId")]
    public AddressObject NextAddressObject { get; set; }
    /// <summary>
