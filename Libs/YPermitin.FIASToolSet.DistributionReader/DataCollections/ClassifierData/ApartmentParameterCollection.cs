...
public class ApartmentParameterCollection : FIASObjectCollection<ApartmentParameter, ApartmentParameterCollection.ApartmentParameterEnumerator>
{
    public ApartmentParameterCollection(string dataFilePath) : base(dataFilePath)
    {
    }
    
    public class ApartmentParameterEnumerator : FIASObjectEnumerator<ApartmentParameter>
    {
        public ApartmentParameterEnumerator(string dataFilePath) : base(dataFilePath)
        {
        }
        ...
        protected override bool MoveNext()
        {
            while (Reader.Read())
            {
                if (Reader.Name == "PARAM")
                {
                    ...
                    var newObject = new ApartmentParameter(
                        id: id,
                        objectId: objectId,
