...
public class HouseParameterCollection : FIASObjectCollection<HouseParameter, HouseParameterCollection.HouseParameterEnumerator>
{
    public HouseParameterCollection(string dataFilePath) : base(dataFilePath)
    {
    }
    
    public class HouseParameterEnumerator : FIASObjectEnumerator<HouseParameter>
    {
        public HouseParameterEnumerator(string dataFilePath) : base(dataFilePath)
        {
        }
        ...
        protected override bool MoveNext()
        {
            while (Reader.Read())
            {
                if (Reader.Name == "PARAM")
                {
                    ...
                    var newObject = new HouseParameter(
                        id: id,
                        objectId: objectId,
